...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Artwork.Reports.View');
	...
	{
		$this->auth->restrict('Artwork.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_artwork())
			{
				...
				redirect(SITE_AREA .'/reports/artwork');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Artwork.Reports.Edit');
		...
		{
			$this->auth->restrict('Artwork.Reports.Delete');
