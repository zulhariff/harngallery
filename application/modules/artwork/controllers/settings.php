...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Artwork.Settings.View');
	...
	{
		$this->auth->restrict('Artwork.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_artwork())
			{
				...
				redirect(SITE_AREA .'/settings/artwork');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Artwork.Settings.Edit');
		...
		{
			$this->auth->restrict('Artwork.Settings.Delete');
