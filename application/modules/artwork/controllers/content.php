...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Artwork.Content.View');
	...
	{
		$this->auth->restrict('Artwork.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_artwork())
			{
				...
				redirect(SITE_AREA .'/content/artwork');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Artwork.Content.Edit');
		...
		{
			$this->auth->restrict('Artwork.Content.Delete');
