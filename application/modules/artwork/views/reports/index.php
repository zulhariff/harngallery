...
$num_columns	= 21;
$can_delete	= $this->auth->has_permission('Artwork.Reports.Delete');
$can_edit		= $this->auth->has_permission('Artwork.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/artwork/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->image); ?></td>
				<?php else : ?>
