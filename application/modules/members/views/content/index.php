...
$num_columns	= 13;
$can_delete	= $this->auth->has_permission('Members.Content.Delete');
$can_edit		= $this->auth->has_permission('Members.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/members/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->firstname); ?></td>
				<?php else : ?>
