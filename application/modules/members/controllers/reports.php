...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Members.Reports.View');
	...
	{
		$this->auth->restrict('Members.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_members())
			{
				...
				redirect(SITE_AREA .'/reports/members');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Members.Reports.Edit');
		...
		{
			$this->auth->restrict('Members.Reports.Delete');
