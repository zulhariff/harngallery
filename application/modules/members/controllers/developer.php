...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Members.Developer.View');
	...
	{
		$this->auth->restrict('Members.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_members())
			{
				...
				redirect(SITE_AREA .'/developer/members');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Members.Developer.Edit');
		...
		{
			$this->auth->restrict('Members.Developer.Delete');
