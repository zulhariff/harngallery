...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Members.Content.View');
	...
	{
		$this->auth->restrict('Members.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_members())
			{
				...
				redirect(SITE_AREA .'/content/members');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Members.Content.Edit');
		...
		{
			$this->auth->restrict('Members.Content.Delete');
