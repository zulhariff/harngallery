...
|
*/
$config['base_url']	= 'http://www.harngallery.com/';
$config['upload_url'] = $config['base_url'].'uploads/';
$config['base_dir'] = '/home1/harngall/public_html/';
$config['upload_dir'] = $config['base_dir'].'uploads/';
$config['website_name'] = 'Harn Gallery';
$config['email_support'] = 'info@harngallery.com';
$config['admin_email']='info@harngallery.com';

$config['item_profile']=$config['base_url'].'members/profile/item/';
