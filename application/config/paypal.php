 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'zul.seller_api1.gmail.com' : 'paypal_api1.louisguillaume.com';
$config['APIPassword'] = $config['Sandbox'] ? '1387098594' : 'R6V7AMELXKUHVWX2';
$config['APISignature'] = $config['Sandbox'] ? 'ATp85JnPvV3oyvki-uHt0UqY8qjqAymE-Zw5T.xdLKn.Nlnn9mdKHGrd' : 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-AdtQ0pwwTSYK24hlXTf-uJKV80wN';
$config['paypal_url'] = $config['Sandbox'] ? 'https://www.sandbox.paypal.com/cgi-bin/webscr' : 'https://www.paypal.com/cgi-bin/webscr';
$config['hosted_button_id'] = $config['Sandbox'] ? 'YK4PJSTZ7KG78' : '57PVPNF7TJ6VC';
 ...
 */
$config['DeveloperEmailAccount'] = $config['Sandbox'] ? 'zulkarnain.shariff@gmail.com' : 'PRODUCTION_DEV_EMAIL_GOES_HERE';
