...
*/
	...
	*/
	...
	$config['cart']['items']['columns']['item_name'] = 'title';
	...
	$config['cart']['items']['columns']['image'] = 'image';
	$config['cart']['items']['columns']['artist'] = 'artist';
	$config['cart']['items']['columns']['artist_id'] = 'artist_id';
	$config['cart']['items']['columns']['artist_email'] = 'artist_email';
	$config['cart']['items']['columns']['country'] = 'country';
	...
	*/
	 ...
	 */ 
	$config['defaults']['currency']['name'] = 'USD';
...
*/
	...
	*/
	...
	$config['database']['order_summary']['search_order_cols'] = array(
		'ord_bill_name', 'ord_bill_company', 'ord_bill_post_code',
		'ord_ship_name', 'ord_ship_bill_company', 'ord_ship_post_code', 'ord_email'
	);
	...
	*/
	...
	$config['database']['order_details']['columns']['image']='ord_artwork_link';
	$config['database']['order_details']['columns']['artist']='ord_artist_name';
	$config['database']['order_details']['columns']['artist_id']='ord_artist_id';
	$config['database']['order_details']['columns']['artist_email']='ord_artist_email';
	$config['database']['order_details']['columns']['country']='ord_artist_country';
	...
	$config['database']['order_details']['custom_columns'] = array(
		...
		'user_note' => 'ord_det_user_note' // This is a removable example linked to the 'user_note' in the $config['cart']['items']['custom_columns'] array at the top.
	);
