...
<div class="control-group">  
	<label class="control-label" for="input01" style="float:left;width:150px">Username</label>  
   <div class="controls">  
      <input type="text" class="input-xlarge" id="input01">    
   </div>  
</div>  
<div class="control-group">  
	<label class="control-label" for="input02" style="float:left;width:150px">Password</label>  
   <div class="controls">  
