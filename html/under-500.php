...
<div  id="browse-art">
		...
		<ul class="breadcrumb">
				...
				<li class="active">Under $500</a></li>				
			</ul>	
...
<!-- Browse Art -->
			...
			<div class="row-fluid">
			<div class="span8">
			<div class="contentTitle">Collection</div>	
			<h4>Original Art for $500 & Under</h4>	
			Great original art under $500 for new and seasoned collectors.
			</div>
			<div class="span4">
